...
public class modules {
  public static moduleConfig fpsCounter = new moduleConfig(4,4, Colors.WHITE,true);
  public static moduleConfig coordinates = new moduleConfig(4,14, Colors.WHITE,true);
  public static moduleConfig crystalCount = new moduleConfig(2,24, Colors.WHITE,true);
  public static moduleConfig expCount = new moduleConfig(2,40, Colors.WHITE,true);
